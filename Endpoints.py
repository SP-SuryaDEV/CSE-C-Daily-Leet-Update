...
github_key =  "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"
...
def Leetcode(username):
    ...
    if response.status_code == 200:
        ...
        return { 'Username' : username , 'Total' : total, 'Total Contests Count' : contestCount, 'Contest Rating' : rating, 'Global Rank' : globalRank, 'Top%' : topPercent, }, True
